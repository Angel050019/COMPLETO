            ...
            <form onSubmit={guardarVenta} className="col-6 mt-5" action="" method="post">
                <div className="card">
                    ...
                    <div className="card-body">
                        ...
                        <input placeholder = "00:00:00 am/pm" className="form-control mb-3" id="hora" required  type="text"/>
                        <input placeholder = "aaaa/mm/dd" className="form-control mb-3" id="fecha" required  type="text"/>
                    </div>
