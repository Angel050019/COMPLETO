            ...
            <form onSubmit={guardarUsuario} className="col-6 mt-5" action="" method="post">
                <div className="card">
                    ...
                    <div className="card-body">
                        <input className="form-control mb-3" id="nombre" required autoFocus type="text" />
                        <input className="form-control mb-3" id="usuario" required  type="text" />
                        <input className="form-control mb-3" id="password" required  type="text" />
